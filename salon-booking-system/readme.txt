...
* Vulnerability fix
* Improved booking availability check when services have break
...
* Fixed issue with plugin settings 
* Hide "manage" button inside email notification when "force guest checkout" is enabled
* Hide "Discount tab" when "Hide price" is active
...
* Fixed issue with new booking email notification

13.02.2026 - 10.30.16

* Fixed issues with missing booking data


09.02.2026 - 10.30.15

* Fixed PayPal payment tracking issue
* Improved booking status management during creation
...
- Fixed issue with free reservations
...
* Fixed vulnerability issue
* Fixed unconsistent slots representation
* Fixed issue with PayPal payment booking status
* Fixed Multi-shops booking form shortcode 
* Fixed email reminders
* Fixed transaction fee calculation when deposit is active
* Added "Exstensions" page on back-end 
