...
class Discounts_Controller extends REST_Controller
{
    ...
    public function prepare_response_for_collection($discount)
    {
        ...
        if($isShopEnabled){
            $res['shops'] = $discount->getMeta('shops');
        }
        return $res;
    }
    ...
    public function create_item( $request )
    {
        ...
        try {
            ...
            return new WP_Error( 'salon_rest_cannot_view', __( 'Sorry, error on create ('.sprintf('%s', $ex->getMessage()).').', 'salon-booking-system' ), array( 'status' => 404 ) );
        }
    ...
    public function update_item( $request )
    {
        ...
        try {
            ...
            return new WP_Error( 'salon_rest_cannot_view', __( 'Sorry, error on update ('.sprintf('%s', $ex->getMessage()).').', 'salon-booking-system' ), array( 'status' => 404 ) );
        }
