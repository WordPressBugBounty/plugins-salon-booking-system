...
class SLN_Action_Sms_Ip1SmsWebservice extends SLN_Action_Sms_Abstract
{
    ...
    public function send($to, $message, $sms_prefix = '')
    {
        ...
        if (defined('WP_DEBUG') && WP_DEBUG) {
            error_log('[IP1SMS DEPRECATION WARNING] The SOAP API is deprecated and will stop working on October 29, 2025. Please migrate to IP1SMS API V2 in SMS Settings.');
        }
