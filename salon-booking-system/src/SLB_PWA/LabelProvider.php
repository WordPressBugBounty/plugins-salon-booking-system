...
class LabelProvider
{
    ...
    public function __construct()
    {
        $this->labels = array(
            ...
            'upcomingReservationsTitle' => __('Upcoming', 'salon-booking-system'),
            'upcomingReservationsNoResultLabel' => __('No upcoming bookings ...', 'salon-booking-system'),
            'upcomingBookingsScrollAriaLabel' => __('Upcoming bookings', 'salon-booking-system'),
            'upcomingPromosSectionTitle' => __('Features & add-ons', 'salon-booking-system'),
            'upcomingPromoCtaLabel' => __('Learn more', 'salon-booking-system'),
            'upcomingPromo1Title' => __('Dynamic pricing', 'salon-booking-system'),
            'upcomingPromo1Body' => __('Offer demand-based pricing with the Dynamic Pricing add-on for Salon Booking System.', 'salon-booking-system'),
            'upcomingPromo2Title' => __('SMS notifications', 'salon-booking-system'),
            'upcomingPromo2Body' => __('Send automated text reminders and cut no-shows with the right messaging add-on.', 'salon-booking-system'),
            'upcomingPromo3Title' => __('Full mobile workflow', 'salon-booking-system'),
            'upcomingPromo3Body' => __('Unlock the calendar, customers, and full booking details in this app with PRO.', 'salon-booking-system'),
            ...
            'proUpgradeModalTitle' => __('PRO feature', 'salon-booking-system'),
            'proUpgradeModalMessage' => __('The calendar and customers directory are available in Salon Booking System PRO. Upgrade to unlock them in the mobile app.', 'salon-booking-system'),
            'proUpgradeModalCtaLabel' => __('View PRO plans', 'salon-booking-system'),
            'proUpgradeModalCloseLabel' => __('Not now', 'salon-booking-system'),
            'proUpgradeBookingDetailsMessage' => __('Opening a booking to view or edit details is available in Salon Booking System PRO. Upgrade to unlock full mobile booking management.', 'salon-booking-system'),
            'pwaLicensePromoFreeProTitle' => __('Unlock Salon Booking PRO', 'salon-booking-system'),
            'pwaLicensePromoFreeProBody' => __('Payments, deposits, SMS, advanced calendar, and the full mobile app workflow — upgrade to a PRO license on our website.', 'salon-booking-system'),
            'pwaLicensePromoFreeProCta' => __('View PRO plans', 'salon-booking-system'),
            'pwaLicensePromoBasicBusinessTitle' => __('Upgrade to Business Plan', 'salon-booking-system'),
            'pwaLicensePromoBasicBusinessBody' => __('Your Basic plan is active. Move up to Business for more included add-ons, higher limits, and advanced features for growing salons.', 'salon-booking-system'),
            'pwaLicensePromoBasicBusinessCta' => __('Compare plans', 'salon-booking-system'),
        );
    }
