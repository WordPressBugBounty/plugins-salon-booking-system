                ...
                <div class="booking-details-customer-info">
                    ...
                    <b-row>
                        <b-col sm="12">
                            <div class="customer-firstname">
                                <b-form-input :placeholder="this.getLabel('customerFirstnamePlaceholder')" v-model="elCustomerFirstname" :class="{required: requiredFields.indexOf('customer_first_name') > -1}" />
                            </div>
                        </b-col>
                    </b-row>
                    <b-row>
                    ...
                    <b-row>
                        <b-col sm="12">
                            <div class="customer-email">
                                <b-form-input :placeholder="this.getLabel('customerEmailPlaceholder')" v-model="elCustomerEmail" @blur="loadDiscounts"/>
                            </div>
                        </b-col>
                    </b-row>
                    <b-row>
                    ...
                    <b-row>
                      <div class="save-as-new-customer">
                        ...
                        >{{ this.getLabel('saveAsNewCustomerLabel') }}</b-form-checkbox>
                      </div>
                    </b-row>
                </div>
            </b-col>
                            ...
                            <div class="service">
                              <vue-select ref="select-service" class="service-select" close-on-select v-model="service.service_id" :options="getServicesListBySearch(servicesList, serviceSearch[index])" label-by="[serviceName, price, duration, category]" value-by="value" :class="{required: requiredFields.indexOf('services_service_' + index) > -1}">
                                ...
                                <li class="vue-select-search">
                                    ...
                                    <b-form-input v-model="serviceSearch[index]" class="vue-select-search-input" :placeholder="this.getLabel('selectServicesSearchPlaceholder')" @mousedown.stop></b-form-input>
                                </li>
                            </div>
                        </b-col>
                        <b-col sm v-if="isShowResource(service)">
                            <div class="resource">
                                <vue-select ref="select-resource" class="service-select" close-on-select v-model="service.resource_id"  :options="getAttendantsOrResourcesListBySearch(resourcesList, resourceSearch[index])" label-by="text" value-by="value" :class="{required: requiredFields.indexOf('services_assistant_' + index) > -1}" @focus="loadAvailabilityResources(service.service_id)">
                                    <template #label="{ selected }">
                                        <template v-if="selected">
                                ...
                                <li class="vue-select-search">
                                    <font-awesome-icon icon="fa-solid fa-magnifying-glass" class="vue-select-search-icon" />
                                    <b-form-input v-model="resourceSearch[index]" class="vue-select-search-input" :placeholder="this.getLabel('selectResourcesSearchPlaceholder')" @mousedown.stop></b-form-input>
                                </li>
                            </div>
                        </b-col>
                        <b-col sm v-if="isShowAttendant(service)">
                            <div class="attendant">
                              <vue-select ref="select-assistant" class="service-select" close-on-select v-model="service.assistant_id"  :options="getAttendantsOrResourcesListBySearch(attendantsList, assistantSearch[index])" label-by="text" value-by="value" :class="{required: requiredFields.indexOf('services_assistant_' + index) > -1}" @focus="loadAvailabilityAttendants(service.service_id)">
                                    <template #label="{ selected }">
                                        <template v-if="selected">
                                            <div class="option-item option-item-selected">
                                                <div class="name">
                                ...
                                <li class="vue-select-search">
                                    <font-awesome-icon icon="fa-solid fa-magnifying-glass" class="vue-select-search-icon" />
                                    <b-form-input v-model="assistantSearch[index]" class="vue-select-search-input" :placeholder="this.getLabel('selectAssistantsSearchPlaceholder')" @mousedown.stop></b-form-input>
                                </li>
                            </div>
                        </b-col>
                    ...
                    <b-row>
                        <b-col sm="6" class="add-service-wrapper">
                            ...
                            <div class="add-service-required">
                                <b-alert :show="requiredFields.indexOf('services') > -1" fade variant="danger">{{ this.getLabel('addServiceMessage') }}</b-alert>
                            </div>
                        </b-col>
                    </b-row>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadDiscounts() {
                ...
                this.axios.get('discounts', { params: {
                    return_active: true,
                    date: this.moment(this.elDate).format('YYYY-MM-DD'),
                    time: this.moment(this.elTime, this.getTimeFormat()).format('HH:mm'),
                    customer_email: this.elCustomerEmail,
            ...
            loadResources() {
                return this.axios.get('resources', {params: {shop: this.shop ? this.shop.id : null}}).then((response) => {
            ...
            loadAvailabilityResources(service_id) {
                this.axios.post('availability/booking/resources', {
                    date: this.moment(this.elDate).format('YYYY-MM-DD'),
                    time: this.moment(this.elTime, this.getTimeFormat()).format('HH:mm'),
                    booking_id: !this.bookingID ? 0 : this.bookingID,
                    selected_service_id: service_id ? service_id : 0,
            ...
            addDiscountsSelectSearchInput(index) {
              ...
              setTimeout(() => {
                window.document
                    .querySelectorAll(".discount .vue-dropdown")[index]
                    .prepend(window.document.querySelectorAll(".discount .vue-select-search")[index])
