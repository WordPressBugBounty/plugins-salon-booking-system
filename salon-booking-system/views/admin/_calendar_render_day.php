    ...
    <div class="cal-day-panel__wrapper clearfix">
            ...
            <?php if (!empty($headers) && count($headers)): ?>
                <div class="cal-day-assistants">
                    <?php foreach ($headers as $head):
                        if (!is_null($head)): ?>
                            <div class="cal-day-assistant"
                                 data-assistant="<?php echo $head['id']; ?>"><?php echo $head['name']; ?></div>
                        <?php else: ?>
        ...
        <div id="cal-day-panel" class="clearfix">
            ...
            foreach ($by_hour as $bsEvent): ?>
                ...
                echo ($counter != $bsEvent->id && !str_contains($bsEvent->displayClass, 'break-down')) ? ' day-event--bdtop' : ' '; ?>"
                     ...
                     data-toggle="tooltip" data-option="day" data-event-id="<?php echo $bsEvent->id; ?>"
                     data-tooltip-id="<?php echo $bsEvent->id; ?>" data-html="true"
                     title="<div class='sln-mouth-tooltip'><?php echo $bsEvent->main ? $bsEvent->title : ''; ?><div style='display: grid; margin-top:0.5rem; margin-left:0.7rem;'>
									...
									<div class="booking_tools">
										...
										<?php if (!$isPro): ?>
                                            <a href="https://www.salonbookingsystem.com/homepage/plugin-pricing/?utm_source=free%20version&utm_medium=booking%20details_mobile_device&utm_campaign=go_pro"
                                               class="more_details_promolink" target="_blank"
