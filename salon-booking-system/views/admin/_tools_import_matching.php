...
<?php foreach($rows as $row): ?>
	<tr class="import_matching">
		<?php foreach($columns as $i => $col): ?>
			<td data-col="<?php echo $i; ?>" placeholder="<?php esc_html_e('Preview', 'salon-booking-system'); ?>"><span class="<?php echo isset($row[$col]) ? 'pull-left' : 'half-opacity'; ?>"><?php echo isset($row[$col]) ? $row[$col] : (esc_html__('Preview', 'salon-booking-system')); ?></span></td>
		<?php endforeach; ?>
	</tr>
<?php endforeach; ?>
<tr class="empty">
