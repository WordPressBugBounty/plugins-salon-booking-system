        ...
        <div class="sln-thankyou__content sln-list">
            ...
            <div class="col-xs-12-- sln-input--action sln-form-actions-- sln-payment-actions--">
                <p><?php echo sprintf(
                        ...
                        esc_html__('You\'ll be redirected in %s seconds', 'salon-booking-system'), '<span class="sln-go-to-thankyou-number"></span>') ?></p>
            ...
            <?php
                ...
                if ($bookingMyAccountPageId && !$plugin->getSettings()->get('enabled_force_guest_checkout') && is_user_logged_in() ) {
                    ...
                    echo '<a class="sln-btn sln-btn--fitcontent sln-btn--borderonly sln-btn--medium" href="' . esc_html(get_permalink($bookingMyAccountPageId)) . ';">' . esc_html_e('Go to your personal account', 'salon-booking-system') . '</a>';
                    echo '</div>';
