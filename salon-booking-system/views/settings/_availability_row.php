...
<div class="col-xs-12 sln-box--sub sln-booking-rule" data-n="<?php echo esc_attr($rulenumber); ?>">
    <h2 class="sln-box-title"><?php esc_html_e('Rule', 'salon-booking-system'); ?>
        <strong><?php echo esc_attr($rulenumber); ?></strong> <span class="block"><?php echo $alert ?></span>
    </h2>
    <div class="sln-title-wrapper">
        ...
        <?php if ($show_specific_dates): ?>
            <div
                class="sln-select-specific-dates sln-profeature <?php echo !defined("SLN_VERSION_PAY") ? 'sln-variable-price--disabled sln-profeature--disabled sln-profeature__tooltip-wrapper' : '' ?>">
                ...
                <div
                    class="sln-switch sln-switch--bare <?php echo !defined("SLN_VERSION_PAY") ? 'sln-disabled' : '' ?>">
    ...
    <div
        class="sln-checkbutton-group <?php echo $show_specific_dates && isset($row['select_specific_dates']) && $row['select_specific_dates'] ? 'hide' : '' ?>">
    ...
    <?php if ($show_specific_dates): ?>
        <div
            class="sln-select-specific-dates-calendar <?php echo isset($row['select_specific_dates']) && $row['select_specific_dates'] ? '' : 'hide' ?>">
            <div class="sln-datepicker-section">
                ...
                <div class="sln-selected-dates-panel">
                    <div class="sln-selected-dates-header">
                        ...
                        <span
                            class="sln-selected-count">0</span>
                    </div>
                    <div class="sln-selected-dates-list">
                        <div
                            class="sln-selected-dates-empty"><?php esc_html_e('No dates selected', 'salon-booking-system'); ?></div>
                    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="row">
                    ...
                    <div class="sln-slider ">
                        ...
                        <div class="sln-slider__inner">
                            <div class="col col-time">
                                <h2 class="sln-slider--title col-time-title"><em><strong
                                            class="slider-time-from">9:00</strong>
                ...
                <div
                    class="col-xs-12 col-md-6 sln-slider-wrapper sln-slider-wrapper-second-shift" <?php if (isset($row['disable_second_shift']) && $row['disable_second_shift']) {
                    echo 'hidden';
                } ?>>
                        ...
                        <div class="sln-slider__inner">
                            <div class="col col-time">
                                <h2 class="sln-slider--title col-time-title" <?php if (isset($row['disable_second_shift']) && $row['disable_second_shift']) {
                                    ...
                                    <em><strong class="slider-time-from">9:00</strong> to <strong
                                            class="slider-time-to">16:00</strong></em>
                                </h2>
