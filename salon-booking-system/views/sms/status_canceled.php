...
/**
 * SMS Template for Canceled Bookings
 * 
 * This template is used to send SMS notifications when a booking is canceled.
 * The same message is sent to both admin and customer (differentiated by phone number).
 * 
 * @var SLN_Plugin          $plugin
 * @var SLN_Wrapper_Booking $booking
 */

$default_template = SLN_Admin_SettingTabs_GeneralTab::getDefaultSmsNotificationMessageCanceled();
$template = $plugin->getSettings()->get('sms_notification_message_canceled') 
            ? $plugin->getSettings()->get('sms_notification_message_canceled') 
            : $default_template;

$bookingDateTime = $plugin->getSettings()->isDisplaySlotsCustomerTimezone() && $booking->getCustomerTimezone() 
