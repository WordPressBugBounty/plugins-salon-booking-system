...
foreach($allServices as $service){
    ...
    $servicesData[$service->getId()] = array(
			...
			'attendants' => $service->getAttendantsIds(),
                        ...
                        'resources' => array_map(function ($i) { return $i->getId(); }, $service->getResources()),
		);
}
...
?>
    <div id="sln_booking_services" class="form-group sln_meta_field row">
        ...
        <div class="col-xs-12 sln-booking-service-line">
                <div class="sln-row sln-booking-service-line__content <?php if ('highend' == $plugin->getSettings()->getAvailabilityMode()) {echo ' sln-booking-service-line__content--highend';} if ($isResourcesEnabled) {echo ' sln-booking-service-line__content--resources';} ?>">
...
?>
        ...
        <div class="col-xs-12 sln-booking-service-line <?php if ('highend' == $plugin->getSettings()->getAvailabilityMode()) {echo ' sln-booking-service-line--highend';} if ($isResourcesEnabled) {echo ' sln-booking-service-line--resources';} ?>">
            <div class="sln-row sln-booking-service-line__content <?php if ('highend' == $plugin->getSettings()->getAvailabilityMode()) {echo ' sln-booking-service-line__content--highend';} if ($isResourcesEnabled) {echo ' sln-booking-service-line__content--resources';} ?>">
                <div class="sln-booking-service--move-line">
                    <div class="bar"></div>
                    <div class="bar"></div>
