                        ...
                        <div class="service-break-slider-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content">
                            ...
                            <span tabindex="0">
                                <div class="sln-slider--break-time-range-min sln-slider--break-time-range-value">
                                    <div class="sln-slider--break-time-from"><div class="sln-slider--break-time-from-value"><?php echo esc_attr($service->getBreakDurationData()['from'])?></div>'</div>
                                </div>
                            </span>
                            <span tabindex="0">
                                <div class="sln-slider--break-time-range-max sln-slider--break-time-range-value">
                                    <div class="sln-slider--break-time-to"><div class="sln-slider--break-time-to-value"><?php echo esc_attr($service->getBreakDurationData()['to'])?></div>'</div>
                                </div>
                            </span>
                        </div>
                    </div>
...
<p><a href="<?php echo $directLink ?>"><?php echo $directLink ?></a></p>
        ...
        <p><?php echo sprintf(
                ...
                __('Please set the Booking page <a href="%s" target="_blank">Settings > General > Salon Booking System required pages</a>', 'salon-booking-system'), admin_url('admin.php?page=salon-settings#sln-salon_booking_system_required_pages'));?></p>
        <?php endif; ?>
    </div>
</div>
    <!-- collapse END -->
